...
let storeOne = new Store("Bethesda suger cookie", 100, 100, 150, 150, 150, 100, 100, 150, 250, 250);
let storeTwo = new Store("Gaithersburg cookie square", 85, 100, 155, 250, 300, 305, 240, 185, 250, 300);
let storeThree = new Store("Germantown cookie store", 90, 105, 150, 195, 250, 300, 300, 300, 300, 300);
let storeFour = new Store("Rio cookie store", 95, 105, 155, 165, 200, 250, 350, 350, 350, 350);   
